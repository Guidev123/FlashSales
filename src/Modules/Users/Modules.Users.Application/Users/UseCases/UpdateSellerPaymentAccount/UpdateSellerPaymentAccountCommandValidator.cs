...
{
    internal sealed class UpdateSellerPaymentAccountCommandValidator : AbstractValidator<UpdateSellerPaymentAccountCommand>
    {
        public UpdateSellerPaymentAccountCommandValidator()
        {
